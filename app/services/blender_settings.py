...
class BlenderSettings:
    ...
    @staticmethod
    def generate_lighting_with_light_script(master_file: str, animation_file: str, collection_list: list,
                                            camera_collection: str,
                                            character_collection: str, start_frame: int, end_frame: int,
                                            output_path: str,
                                            output_path_progress: str,
                                            scene_name: str, crypto_node: str, output_node: list, method: bool,
                                            json_preset_filepath: str, blend_preset_filepath: str,
                                            lighting_plugin_key: str) -> str:
        tpl = Template(dedent("""
            import bpy
            import re
            import mathutils
        ...
        script = tpl.substitute(
            ...
            OUTPUT_NODES=output_node,
            METHOD=method,
            JSON_PRESETS_FILEPATH=json_preset_filepath,
            BLEND_PRESETS_FILEPATH=blend_preset_filepath,
            LIGHTING_PROPS_KEY=lighting_plugin_key,
        )
